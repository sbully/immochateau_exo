...
if(!empty($_POST['Type_bien'])&&!empty($_POST['Titre'])&&!empty($_POST['Nombre_pieces'])&&!empty($_POST['Surface'])&&!empty($_POST['Prix_loc'])&&
    !empty($_POST['Description'])&&!empty($_POST['GES'])&&!empty($_POST['Classe_ECO'])&&!empty($_POST['Meubles'])&&!empty($_POST['Localisation'])&&
        !empty($_POST['Id_ville'])&&!empty($_POST['Departement'])&&!empty($_POST['Id_proprietaire'])&&!empty($_POST['Charges_inc'])){
